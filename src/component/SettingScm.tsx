        ...
        return (
            ...
            <div className={this.svc+"-htm"}>
                    <div className="group">
                        ...
                        <input id={this.svc+"_url"} type="text" className="input" value={this.state.url} onChange={(event)=> {this.setState({...this.state, url: event.target.value})}}/>
                    </div>
                    <div className="group">
                        <label htmlFor={this.svc+"id"} className="label">ID</label>
                        <input id={this.svc+"_id"} type="text" className="input" value={this.state.id} onChange={(event)=> {this.setState({...this.state, id: event.target.value})}}/>
                    </div>
                    <div className="group">
                        <label htmlFor={this.svc+"_pass"} className="label">PW</label>
                        <input id={this.svc+"_pass"} type="password" className="input" data-type="password" value={this.state.pw} onChange={(event)=> {this.setState({...this.state, pw: event.target.value})}}/>
                    </div>
            </div>
